        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            <tr className="border-b border-zinc-100 dark:border-zinc-800">
              <td className="p-4 font-medium text-zinc-500 dark:text-zinc-400">Cost</td>
              {all.map((key) => (
            ...
            <tr className="border-b border-zinc-100 dark:border-zinc-800">
              <td className="p-4 font-medium text-zinc-500 dark:text-zinc-400">Timeline</td>
              {all.map((key) => (
                <td key={key} className="p-4 text-zinc-700 dark:text-zinc-300">
            ...
            <tr>
              <td className="p-4 font-medium text-zinc-500 dark:text-zinc-400">Maintenance</td>
              {all.map((key) => (
                <td key={key} className="p-4 text-zinc-700 dark:text-zinc-300">
