...
import { getProjectIcon, getProjectColor, getToolIcon, getToolColor } from '@/components/ProjectIcons'
  ...
  return (
    ...
    >
      ...
      <section className="mt-16 border-t border-zinc-100 pt-10 dark:border-zinc-700/40">
        ...
        <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
          Open-source projects, apps and libraries. Check out the code, contribute, or
