...
**Question:** What would a fully agentic service agency look like - one where AI agents own strategy *and* execution - and how would we build it without losing control of risk, cost, or accountability?
