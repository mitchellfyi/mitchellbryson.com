...
This template is intentionally small. It proves or disproves value in ten days, keeps spend contained, and leaves you with artefacts the team can run without you.
