RAG systems are mostly a data quality problem
if you want good answers
you need to clean up your data first
...
use both keyword search
and semantic search
then combine the results
rerank results to get the most relevant ones first
measure everything with a fixed test set
before you ship
...
and get that working perfectly
before you scale up
