  ...
  const cardsHtml = results
    .map((r) => {
      const siteLinkHtml = r.siteLink
        ? `<a href="${siteUrl}${r.siteLink}" style="color: ${C.TEAL}; font-size: 13px; font-weight: bold; text-decoration: none; margin-right: 16px;">How I use it &rarr;</a>`
        : ''
  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid ${C.BORDER}; color: ${C.TEXT}; font-size: 13px;">
        <p>This report was generated by the <a href="${permalink || siteUrl + '/projects/tools/tech-stack-picker'}" style="color: ${C.TEAL};">Tech Stack Picker</a> tool on mitchellbryson.com.</p>
...
export async function POST(request) {
  const { email, toolName, permalink, results } = await request.json()
