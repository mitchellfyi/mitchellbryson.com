  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
      ...
      <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid ${C.BORDER}; color: ${C.TEXT}; font-size: 13px;">
        <p>This report was generated by the <a href="${permalink || siteUrl + '/projects/tools/ai-readiness-score'}" style="color: ${C.TEAL};">AI Readiness Score</a> tool on mitchellbryson.com.</p>
