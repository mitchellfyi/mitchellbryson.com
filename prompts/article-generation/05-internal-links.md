...
8. **Preserve all existing content exactly.** Don't change wording, structure, formatting, or line breaks. Only insert `[text](/url)` markdown links around existing phrases.
